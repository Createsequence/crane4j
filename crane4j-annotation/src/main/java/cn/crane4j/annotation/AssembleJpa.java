...
/**
 * Declare an operation of assemble using the jpa native query as the data source.
 *
 * @author huangchengxing
 * @see cn.crane4j.core.parser.TypeHierarchyBeanOperationParser;
 * @see cn.crane4j.extension.jpa.AssembleJpaAnnotationHandler;
 * @since 1.2.0
 */
@Repeatable(value = AssembleJpa.List.class)
@Documented
@Target({ElementType.ANNOTATION_TYPE, ElementType.FIELD, ElementType.TYPE, ElementType.METHOD, ElementType.PARAMETER})
@Retention(RetentionPolicy.RUNTIME)
public @interface AssembleJpa {
